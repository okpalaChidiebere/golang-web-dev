...
func main() {
	...
	encodeStd := "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/" //You pass to new endcoding this standard. You can pass in any standard you want.
